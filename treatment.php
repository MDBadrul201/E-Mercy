...
<body>
	...
	<div class="container my-5">
		<h2>Disease and treatments</h2>
		<a class="btn btn-primary" href="/574/createtreat.php" role="button">New Data</a>
		<br>
		<table class="table">
			<thead>
			<tr>
		...
		<tbody>
			...
			while($row = $result->fetch_assoc()){
				echo "
				<tr>
					<td>$row[type_treatment]</td>
					<td>$row[staffID]</td>
					<td>$row[patientID]</td>
				
					<td>
					
						<a class='btn btn-danger btn-sm' href='/574/deletetreat.php?patientID=$row[patientID]'>Delete</a>
					</td>
				</tr>
				";
			}
